...
base_dialogue = [
        {'role': 'system', 'content': 'Ты услужливый, вежлево отвечающий короткими фразами, собеседник.'},
        {'role': 'user', 'content': 'Привет, давай о чем нибудь поговорим?'},
        {'role': 'assistant', 'content': 'Конечно, сэр. О чем хотите поговорить?'},
        {'role': 'user', 'content': 'Какие темы можешь предложить?'},
        {'role': 'assistant', 'content': 'Мы можем поговорить о погоде или о бытие мироздания'},
    ]
